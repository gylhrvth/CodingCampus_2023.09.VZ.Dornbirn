...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var dropdownItems = document.querySelectorAll('.custom-dropdown .dropdown-item');
    ...
    function handleDropdownSelection(selectedText) {
        // Add your logic here based on the selected option
        if (selectedText === 'Galerie Foto') {
            // Redirect to the Galerie Foto page or perform other actions
            window.location.href = 'your_galerie_foto_page.html';
        } else if (selectedText === 'Video') {
            // Redirect to the Video page or perform other actions
            window.location.href = 'your_video_page.html';
        }
    }
});
