namespace Fabian.Week06._04Zoo
{
    public class ZooMain
    {
        public static void Start()
        {
            ...
            AnimalDoctor alex = new("Alex");
            AnimalDoctor kurt = new("Kurt");

            Animal paul = new("Paul", "Goat", wheat, 4, 40, 20);
            Animal bella = new("Bella", "Goat", wheat, 3, 30, 15);
            Animal rijska = new("Rijska", "Cow", wheat, 5, 50, 25);
            Animal garmond = new("Garmond", "Horse", straw, 5, 50, 20);
            Animal hugo = new("Hugo", "Horse", straw, 8, 80, 40);
            Animal idaxis = new("Idaxis", "Horse", straw, 2, 20, 10);
            Animal rex = new("Rex", "Chameleon", crickets, 1, 20, 10);
            Animal camo = new("Camo", "Chameleon", crickets, 2, 40, 25);
            Animal bro = new("Bro", "Chameleon", crickets, 1, 30, 20);
            ...
            zoo.AnimalDoctors.Add(alex);
            zoo.AnimalDoctors.Add(kurt);
