...
namespace DarioLuis.Zoo_Dario
{
    public class Zoo_Main
    {
        public static void Start()
        {
            ...
            //Animaldoctor defeniert
            AnimalDoctor martin = new("Martin");
            AnimalDoctor didi = new("Didi");
            ...
            Animal david = new("David", "Chameleon", crickets, 2, 40, 20);
            ...
            //Zookeepers hinzugefügt
            zoo.Zookeepers.Add(hassan);
            zoo.Zookeepers.Add(gyula);

            //Animaldoctors hinzugefügt
            zoo.AnimalDoctors.Add(martin);
            zoo.AnimalDoctors.Add(didi);
